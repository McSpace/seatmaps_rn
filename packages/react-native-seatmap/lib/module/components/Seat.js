 ...
 */
function getLabelZone(seatType) {
  ...
  return /*#__PURE__*/_jsxs(TouchableOpacity, {
    ...
    children: [/*#__PURE__*/_jsx(SeatIcon, {
      ...
      children: [/*#__PURE__*/_jsx(Text, {
        style: [styles.label, {
          fontSize: Math.max(7, W * fontMult)
        }],
        numberOfLines: 1,
        adjustsFontSizeToFit: true,
        children: String(number || letter || '')
      }), !!seat.price && H > 40 && /*#__PURE__*/_jsx(Text, {
        style: [styles.price, {
          fontSize: Math.max(5, W * fontMult * 0.65)
        }],
        numberOfLines: 1,
        adjustsFontSizeToFit: true,
        children: seat.price
      })]
    }), !!passenger && /*#__PURE__*/_jsx(View, {
      style: {
        position: 'absolute',
        top: (H - W * 0.8) / 2,
        left: (W - W * 0.8) / 2,
