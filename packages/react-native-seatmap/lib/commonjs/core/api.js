...
exports.JetsApiService = void 0;
var _constants = require("./constants");
const JWT_TOKEN = 'jetsJwtToken';
const TOKEN_EXPIRATION_BUFFER_IN_MS = 300000;
class JetsApiService {
  constructor(appId, key, url, localStorage, apiAuthorizationScheme = _constants.DEFAULT_AUTHORIZATION_SCHEME, apiMetadata = null) {
    this._appId = appId;
    this._apiKey = key;
    this._apiUrl = url;
...
exports.JetsApiService = JetsApiService;
