...
export type { SeatMapConfig, SeatMapCallbacks, PreparedData, PreparedDeck, PreparedRow, PreparedSeat, SeatSize, SeatFeature, SeatMeasurement, SeatStatus, SeatEntityType, WingsInfo, SeatMapParams, Passenger, ColorTheme, } from './types';
...
export { ENTITY_STATUS_MAP, ENTITY_TYPE_MAP, CLASS_CODE_MAP, LOCALES_MAP, DEFAULT_LANG, DEFAULT_SEAT_MAP_WIDTH, SEAT_SIZE_BY_TYPE, } from './core/constants';
